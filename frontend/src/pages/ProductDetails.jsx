...
const ProductDetails = () => {
  ...
  useEffect(() => {
    if (product && Array.isArray(products) && products.length > 0) {
      const sameCat = products.filter((item) => item?.category === product.category)
  ...
  const rating = 4 // hardcoded per your request
    ...
    <div className="mt-12">
        ...
        <div className="text-sm w-full md:w-1/2">
          ...
          <div className="flex items-center mt-10 gap-4 text-base">
            ...
            <button
              ...
              className="w-full py-3.5 cursor-pointer font-medium bg-[var(--color-primary)] text-white hover:bg-[var(--color-primary-hover)] transition"
            >
              Buy now
            </button>
          </div>
      ...
      <div className="flex flex-col items-center mt-20">
        ...
        <button
          ...
          className="mt-5 mx-auto cursor-pointer px-12 my-16 py-2.5 border rounded text-primary hover:bg-primary/10 transition"
        >
          See More
        </button>
      </div>
